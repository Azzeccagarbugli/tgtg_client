...
/// A scraper for accessing the last number version of the **Too Good Too Go** app.
///
...
class GooglePlayScraper {
  ...
  /// The url of the Google Play Store page of the **Too Good Too Go** app.
  final String _url;

  /// Returns the last version number of the **Too Good Too Go** app.
